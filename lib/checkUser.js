...
export const checkUser = async () => {
  try {
    // Build-time safety: Skip if database URL is missing (CI/CD build phase)
    ...
    const credits = PLAN_CREDITS[currentPlan] || 1;
    ...
    if (loggedInUser) {
      // Interviewers don't have a credit subscription â€” skip allocation
    ...
    // New user â€” create with credits from their current plan
