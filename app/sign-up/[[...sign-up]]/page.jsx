...
import { ArrowLeft, Sparkles, UserPlus, Trophy, Compass, CheckCircle2 } from "lucide-react";
        ...
        <div className="lg:col-span-6 space-y-8 text-left hidden lg:block">
          ...
          >
            ...
            <h1 className="text-5xl font-extrabold leading-tight text-white tracking-tight font-sans">
              Create Your <br />
              <span className="text-gradient-gold">PrepWise Account</span>
            </h1>
            <p className="text-zinc-400 text-lg leading-relaxed max-w-lg">
              Sign up today and get access to expert mentors, personalized career roadmaps, and instant AI-driven interview feedback.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="glass-gold p-6 rounded-2xl relative overflow-hidden group hover:border-amber-400/20 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-semibold text-white">Free Credits</h3>
              </div>
              <div className="flex items-baseline gap-1.5">
                <span className="text-3xl font-black text-amber-400">+1 Credit</span>
                <span className="text-xs text-zinc-500">Upon Sign Up</span>
              </div>
            </div>

            {/* Card 2: Leaderboard & Career Roadmap */}
            <div className="glass-gold p-6 rounded-2xl relative overflow-hidden group hover:border-amber-400/20 transition-all duration-300">
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-amber-500/10 to-transparent rounded-bl-full pointer-events-none" />
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-amber-400/10 rounded-lg text-amber-400">
                ...
                <h3 className="font-semibold text-white">Rank & Paths</h3>
              </div>
              <div className="flex items-center gap-2 text-xs text-zinc-300">
                <Compass className="size-4 text-amber-400" />
                <span>Frontend, Backend & Mobile</span>
              </div>
            </div>

            {/* Card 3: Feedback Info */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-semibold uppercase tracking-wider text-amber-400">Why PrepWise AI?</span>
                  </div>
                  <p className="text-sm text-zinc-300">
                    We sync your custom user dashboard instantly. Track mock interviews, rate session rubrics, and access stream-compatible video calls with industry leads.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center gap-6 pt-4 border-t border-zinc-800 text-zinc-500 text-xs">
            <div className="flex items-center gap-2">
              ...
              <span>Free credit on first login</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle2 className="size-4 text-amber-400/80" />
              <span>Real-time mentor matching</span>
            </div>
          </div>
        </div>
